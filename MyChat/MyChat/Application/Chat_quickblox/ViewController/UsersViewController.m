...
- (IBAction)createDialogbox:(id)sender{
...
//            DialogsViewController *dialogsViewController = weakSelf.navigationController.viewControllers[0];
            self.dialogsViewController.createdDialog = createdDialog;
...
//    NSString* profileurl = user.customData;
//    if (profileurl)
//    {    
//    profileImgURL= [profileImageBaseURL stringByAppendingString: profileurl];
//    [cell.imageView sd_setImageWithURL:[NSURL URLWithString:profileImgURL]
