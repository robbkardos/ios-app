...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [QBApplication sharedApplication].applicationId = 36552;
    [QBConnection registerServiceKey:@"yk3FDpHvn8Rkp-r"];
    [QBConnection registerServiceSecret:@"vMh4g9GghHCQrsw"];
    [QBSettings setAccountKey:@"EQjTqWepZwp99Ntb8ozp"];
